...
※ 認証機能やドキュメント作成、テストの拡充等、まだやり残している部分も多いです。
...
| スタイル（css）                | emotion                             | 利用者の多い material-ui の次のバージョン(v5) の dependency であり、今後の普及すると考えたため。css を変数や関数で扱うことを可能にし、css の再利用可能性を高めるため。                                                                                                                                 |
