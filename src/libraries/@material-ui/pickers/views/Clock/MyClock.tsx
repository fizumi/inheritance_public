...
import { VIEW_HEIGHT, HEADER_HEIGHT } from '../../constants/dimensions'
...
export const useStyles = makeStyles(
  (theme) => ({
    root: {
      ...
      position: 'relative',
      minHeight: VIEW_HEIGHT - HEADER_HEIGHT,
      alignItems: 'center',
    },
    clock: {
...
export function Clock<TDate>(props: ClockProps<TDate>) {
  ...
  const handleValueChange = (newValue: number, isFinish: PickerSelectionState) => {
    console.condlog('date picker', 'handleValueChange', isFinish)
  ...
  const handleMouseUp = (e: React.MouseEvent) => {
    ...
    console.condlog('date picker', 'MyClock handleMouseUp')
    ...
    <div className={classes.root}>
      ...
      {ampm && (wrapperVariant === 'desktop' || ampmInClock) && (
        <React.Fragment>
          ...
          >
            <Typography variant="caption">午前</Typography>
          </IconButton>
          <IconButton
            disabled={meridiemMode === null}
          ...
          >
            <Typography variant="caption">午後</Typography>
          </IconButton>
        </React.Fragment>
      )}
    </div>
