  ...
  const handleChangeAndOpenNext = React.useCallback(
    (date: unknown, currentViewSelectionState?: PickerSelectionState) => {
      ...
      const globalSelectionState =
        ...
        isSelectionFinishedOnCurrentView && Boolean(nextView) && openView !== 'date' // 'date' の選択なら終了
          ? 'partial'
          : currentViewSelectionState
      // console.log('handleChangeAndOpenNext', { currentViewSelectionState, globalSelectionState })
    ...
    [nextView, onChange, openNext, openView]
  )
