...
import { useMaskedInput } from './hooks/useMyMaskedInput' // My
...
export const KeyboardDateInput: React.FC<DateInputProps & DateInputRefs> = ({
  ...
  //                     ↓ mask の考慮だけでなく、textFieldProps 全般を扱う。
  ...
  return renderInput({
    ...
    InputProps: {
      ...
      [`${adornmentPosition}Adornment`]: hideOpenPickerButton ? undefined : (
        // <InputAdornment position={adornmentPosition} {...InputAdornmentProps}> // margin を除去したい
