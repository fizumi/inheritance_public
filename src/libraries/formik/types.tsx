...
export declare type FormikErrors<Values> = {
  [K in keyof Values]?: Values[K] extends any[]
    ? Values[K][number] extends tb.O.Object
      ? FormikErrors<Values[K][number]>[] | string | string[]
      : string | string[]
    : Values[K] extends tb.O.Object
...
export interface FormikHelpers<Values> {
  ...
  /** 自分で追加 */
  setFocus: (field?: string | undefined) => void
 ...
 */
export interface FormikSharedConfig<Props = unknown> {
...
export interface FormikConfig<Values> extends FormikSharedConfig {
   ...
   */
  validate?: (values: Values) => void | tb.O.Object | Promise<FormikErrors<Values>>
...
/** Field metadata */
export interface FieldMetaProps<Value, Values = any> {
  /** Value of the field */
  value: Value
  values?: Values //add
...
export interface FieldInputProps<Value> {
  ...
  /***/
  ref: (instance: FieldElement | null) => void
}
